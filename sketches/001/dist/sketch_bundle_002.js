...
window.onload = function () {
  ...
  function IsoBlock() {
    var ogHeight = Math.floor(Math.random() * (400 - 100 + 1)) + 100;
    var height = ogHeight;
    var dir = 'up';

    this.updateHeight = function () {
      if (height < ogHeight && dir === 'up') height++;else if (height > 100 && dir === 'down') height--;else if (height === ogHeight) dir = 'down';else if (height === 100) dir = 'up';
    };
    ...
    var a = new Point(0, 0);
    var b = new Point(a.x + 10, a.y - 5.77);
    var c = new Point(b.x - 8.29, b.y - 5);
    var d = new Point(c.x - 10, c.y + 5.77);
    var basePts = [a, b, c, d];
    basePts = basePts.map(function (pair) {
      // scale up basePts
      pair.x = pair.x * 10;
      pair.y = pair.y * 10;
      return pair;
    ...
    this.draw = function () {
      var basePtsPrime = basePts.map(function (pt) {
        // copy the basePts up to create top of block
        return new Point(pt.x, pt.y - height);
      });
      var left = drawSide([basePts[0], basePts[3], basePtsPrime[3], basePtsPrime[0]], '#cccccc');
      var right = drawSide([basePts[0], basePts[1], basePtsPrime[1], basePtsPrime[0]], '#a3a3a3');
      var top = drawSide(basePtsPrime, '#eaeaea');
      var rec = new Group([left, right, top]);
  ...
  var ogPt = new Point(canvas.width / 2 - 100, -150);
  var row = 0;
  var col = 0;
  var isoBlocks = [];
  for (var i = 0; i < 200; i++) {
    ...
    var pt = new Point(row * 82.89 + ogPt.x + -100 * col, row * 50 + ogPt.y + 57.699 * col);
    var block = new IsoBlock();
  ...
  _paper2.default.view.onFrame = function (e) {
    //if(e.count % 30  === 0) {
    project.clear();
    isoBlocks.forEach(function (block) {
      block.updateHeight();
      block.draw();
    });
    //}
